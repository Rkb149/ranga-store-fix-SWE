const loadProducts = () => {
  ...
  // const url = `https://raw.githubusercontent.com/biswajitdasme/fakestore/main/db.json?fbclid=IwAR2LuTykQ50xVBxB1Xj5PgouBbXhjwQC2NC_hqfXY9EJ8zUbQIpqRD_qXOs`
  fetch(url)
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${product.image}></img>
      ...
      <div> 
      <i class="fas fa-star">  ${product.rating.rate} </i>
